...
public class Exercise12_20 {
    ...
    private static final String RESOLVE_//package_PATH = "src\\ch_12\\exercise12_18\\";
    ...
    public static void main(String[] args) {
        ...
        Path parentPath = Paths.get(RESOLVE_//package_PATH, args[0]);
...
//            dirIterException.printStackTrace();
        ...
        for (Path subPath : parentFiles) {
            ...
            handleRemove//packageStatement(subPath);
        }

    }

    private static void handleRemove//packageStatement(Path path) {
